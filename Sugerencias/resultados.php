...
<body>
    ...
    <div class="container">
        ...
        <div class="results">
            <div class="candidate">
                <h2><span style="color: #a30280; text-shadow: -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff;"><?php echo htmlspecialchars($nombrePartido1); ?></span></h2>
                <img src="Img\mari2.jpg" alt="Nombre del candidato2">
                <div class="percentage"><?php echo number_format(calcularPorcentaje($votosPorPartido[1], $totalVotos), 2) . '%'; ?></div>
                <div class="votes">Votos: <?php echo isset($votosPorPartido[1]) ? $votosPorPartido[1] : 0; ?></div> <!-- Aquí muestra los votos -->

            </div>
            <div class="candidate">
            <h2><span style="color: blue; text-shadow: -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff;"><?php echo htmlspecialchars($nombrePartido2); ?></span></h2>
            <img src="Img\CANDIDATA2.jpg" alt="Nombre del candidato1">
            <div class="percentage"><?php echo number_format(calcularPorcentaje($votosPorPartido[2], $totalVotos), 2) . '%'; ?></div>
            <div class="votes">Votos:<?php echo isset($votosPorPartido[2]) ? $votosPorPartido[2] : 0; ?></div> <!-- Aquí muestra los votos -->
            </div>
        </div>
